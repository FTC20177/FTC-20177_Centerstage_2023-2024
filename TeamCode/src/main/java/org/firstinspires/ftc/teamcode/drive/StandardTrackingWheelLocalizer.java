...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = 1.2/2; // in
    ...
    public static double X_MULTIPLIER = 1.19; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.23; // Multiplier in the Y direction
